...
class MempoolPackagesTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        self.nodes = []
        self.nodes.append(start_node(0, self.options.tmpdir, ["-maxorphantx=1000", "-relaypriority=0", "-debug=mempool",  "-limitdescendantcount=25", "-limitancestorcount=25", "-limitancestorsize=101", "-limitdescendantsize=101"]))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-maxorphantx=1000", "-relaypriority=0", "-limitancestorcount=5", "-debug=mempool"]))
