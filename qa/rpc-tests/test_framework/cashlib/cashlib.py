...
class ScriptError(IntEnum):
    ...
    SCRIPT_ERR_INVALID_BITFIELD_SIZE = 27
    SCRIPT_ERR_INVALID_BIT_RANGE = 28
    SCRIPT_ERR_NEGATIVE_LOCKTIME = 29
    SCRIPT_ERR_UNSATISFIED_LOCKTIME = 30
    SCRIPT_ERR_SIG_HASHTYPE = 31
    SCRIPT_ERR_SIG_DER = 32
    SCRIPT_ERR_MINIMALDATA = 33
    SCRIPT_ERR_SIG_PUSHONLY = 34
    SCRIPT_ERR_SIG_HIGH_S = 35
    SCRIPT_ERR_SIG_NULLDUMMY = 36
...
class ScriptFlags(IntFlag):
    ...
    STANDARD_SCRIPT_VERIFY_FLAGS = MANDATORY_SCRIPT_VERIFY_FLAGS | SCRIPT_VERIFY_DERSIG | SCRIPT_VERIFY_MINIMALDATA | SCRIPT_VERIFY_NULLDUMMY | SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS | SCRIPT_VERIFY_CLEANSTACK | SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY | SCRIPT_VERIFY_CHECKSEQUENCEVERIFY | SCRIPT_ENABLE_CHECKDATASIG;
