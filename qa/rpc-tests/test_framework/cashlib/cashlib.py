...
class ScriptError(IntEnum):
    ...
    SCRIPT_ERR_SIG_BADLENGTH = 38,
    SCRIPT_ERR_MUST_USE_FORKID = 39,
    
    SCRIPT_ERR_DISCOURAGE_UPGRADABLE_NOPS = 40
    SCRIPT_ERR_NONCOMPRESSED_PUBKEY = 41
    SCRIPT_ERR_NUMBER_OVERFLOW = 42
    SCRIPT_ERR_NUMBER_BAD_ENCODING = 43
...
class ScriptFlags(IntFlag):
    ...
    SCRIPT_VERIFY_CHECKDATASIG_SIGOPS = (1 << 18)
    SCRIPT_ENABLE_SCHNORR = (1 << 19)
    SCRIPT_ALLOW_SEGWIT_RECOVERY = (1 << 20)
    ...
    STANDARD_SCRIPT_VERIFY_FLAGS = MANDATORY_SCRIPT_VERIFY_FLAGS | SCRIPT_VERIFY_DERSIG | SCRIPT_VERIFY_MINIMALDATA | SCRIPT_VERIFY_NULLDUMMY | SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS | SCRIPT_VERIFY_CLEANSTACK | SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY | SCRIPT_VERIFY_CHECKSEQUENCEVERIFY | SCRIPT_VERIFY_CHECKDATASIG_SIGOPS;
