...
class PruneTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        self.nodes.append(start_node(0, self.options.tmpdir, ["-debug","-rpcservertimeout=0", "-maxreceivebuffer=20000","-blockmaxsize=999000", "-checkblocks=5", "-maxreorgdepth=-1"], timewait=900))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-debug","-rpcservertimeout=0", "-maxreceivebuffer=20000","-blockmaxsize=999000", "-checkblocks=5", "-maxreorgdepth=-1"], timewait=900))

        # Create node 2 to test pruning
        self.nodes.append(start_node(2, self.options.tmpdir, ["-debug","-rpcservertimeout=0", "-maxreceivebuffer=20000","-prune=550", "-maxreorgdepth=-1"], timewait=900))
    ...
    def test_height_after_sync(self):
        self.nodes.append(start_node(3, self.options.tmpdir, ["-debug","-rpcservertimeout=0", "-maxreceivebuffer=20000","-blockmaxsize=999000", "-checkblocks=5", "-maxreorgdepth=-1"], timewait=900))
    ...
    def create_chain_with_staleblocks(self):
        ...
        for j in range(12):
            ...
            self.nodes[0]=start_node(0, self.options.tmpdir, ["-debug","-rpcservertimeout=0", "-maxreceivebuffer=20000","-blockmaxsize=999000", "-checkblocks=5", "-maxreorgdepth=-1"], timewait=900)
    ...
    def reorg_test(self):
        ...
        self.nodes[1]=start_node(1, self.options.tmpdir, ["-debug","-rpcservertimeout=0", "-maxreceivebuffer=20000","-blockmaxsize=5000", "-checkblocks=5", "-disablesafemode", "-maxreorgdepth=-1"], timewait=900)
