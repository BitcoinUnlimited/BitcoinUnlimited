...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0]=start_node(0, self.options.tmpdir, ["-debug","-logtimemicros","-relaypriority=1", "-minrelaytxfee=0.0001"])
        ...
        stop_node(self.nodes[0],0)
        self.nodes[0]=start_node(0, self.options.tmpdir, ["-debug","-logtimemicros","-relaypriority=1", "-minrelaytxfee=0.00001"])
        assert(len(self.nodes[0].getrawmempool()) == 0)
