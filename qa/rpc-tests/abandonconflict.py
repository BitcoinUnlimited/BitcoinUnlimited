...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        inputs =[]
        # spend 1BCH outputs from txA and txB
        ...
        # Identify the 1.499998BCH output
        ...
        # Verify that B and C's 1 BCH outputs are available for spending again because AB1 is now conflicted
        newbalance = self.nodes[0].getbalance()
