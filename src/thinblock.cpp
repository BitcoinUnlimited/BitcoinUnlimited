...
bool CXThinBlock::process(CNode *pfrom, int nSizeThinBlock, string strCommand)
{
    ...
    if (collision)
    {
        ...
        // This must be done outside of the mempool.cs lock or the deadlock detection with pfrom->cs_vSend will be
        // triggered.
