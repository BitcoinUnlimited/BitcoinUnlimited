...
public:
    ...
    void SetInputDataValidity(bool state)
    {
        vData[index].isValid = state;
    }
};
...
public:
    ...
    void AddMetadata(const std::string &keyIn, const std::string &valueIn)
    {
        txMetadata.emplace(keyIn, valueIn);
    }
    bool GetMineable()
    {
        return mineable;
    }
    void SetMineable(bool state)
    {
        mineable = state;
    }
    bool GetFutureMineable()
    {
        return futureMineable;
    }
    void SetFutureMineable(bool state)
    {
        futureMineable = state;
    }
    bool GetStandard()
    {
        return standard;
    ...
    bool InputsCheck1IsValid()
    {
        return inputsCheck1.isValid;
    }
