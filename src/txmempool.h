...
private:
    ...
    //! Runtime signature operation count
    uint64_t runtimeSigOpCount; 
    //! Runtime bytes hashed for signature operations
    uint64_t runtimeSighashBytes; 
...
private:
    ...
    //BU: tx's per second accepted into the mempool
    double nTxPerSec; 
