...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("Zero-confirmation StarbucksCoin"),
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr("Zero-confirmation StarbucksCoin"), QObject::tr("Error: %1").arg(e.what()));
        return 1;
    }
#ifdef ENABLE_WALLET
