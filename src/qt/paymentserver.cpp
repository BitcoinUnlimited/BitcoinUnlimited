...
{
    std::array<const std::string *, 6> networks = {{&CBaseChainParams::MAIN, &CBaseChainParams::TESTNET,
        &CBaseChainParams::UNL, &CBaseChainParams::TESTNET4, &CBaseChainParams::CHIPNET, &CBaseChainParams::REGTEST}};
