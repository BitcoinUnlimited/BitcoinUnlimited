...
BOOST_AUTO_TEST_CASE(sizes)
{
    ...
    BOOST_CHECK_EQUAL(GetSerializeSize(char(0), 0), 1UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(int8_t(0), 0), 1UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint8_t(0), 0), 1UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(int16_t(0), 0), 2UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint16_t(0), 0), 2UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(int32_t(0), 0), 4UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint32_t(0), 0), 4UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(int64_t(0), 0), 8UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint64_t(0), 0), 8UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(float(0), 0), 4UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(double(0), 0), 8UL);
    BOOST_CHECK_EQUAL(GetSerializeSize(bool(0), 0), 1UL);
}
