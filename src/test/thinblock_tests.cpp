...
BOOST_AUTO_TEST_CASE(thinblock_test)
{
    ...
    BOOST_CHECK_EQUAL(9UL, thinblock.vMissingTx.size());
    BOOST_CHECK_EQUAL(9UL, xthinblock.vMissingTx.size());
    ...
    BOOST_CHECK_EQUAL(9UL, thinblock1.vMissingTx.size());
    BOOST_CHECK_EQUAL(9UL, xthinblock1.vMissingTx.size());
    ...
    BOOST_CHECK_EQUAL(8UL, thinblock2.vMissingTx.size());
    BOOST_CHECK_EQUAL(8UL, xthinblock2.vMissingTx.size());
