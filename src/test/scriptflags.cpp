...
static std::map<std::string, uint32_t> mapFlagNames = {
    ...
    {"MINIMALIF", SCRIPT_VERIFY_MINIMALIF}, {"NULLFAIL", SCRIPT_VERIFY_NULLFAIL},
    ...
    {"COMPRESSED_PUBKEYTYPE", SCRIPT_VERIFY_COMPRESSED_PUBKEYTYPE}, {"SIGHASH_FORKID", SCRIPT_ENABLE_SIGHASH_FORKID},
    {"REPLAY_PROTECTION", SCRIPT_ENABLE_REPLAY_PROTECTION}, {"MONOLITH_OPCODES", SCRIPT_ENABLE_MONOLITH_OPCODES},
};
