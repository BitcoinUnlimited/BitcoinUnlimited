...
public:
    ...
    CKey GetKey();
    bool IsValid(const CChainParams &) const;
    bool SetString(const CChainParams &, const char *pszSecret);
    bool SetString(const CChainParams &, const std::string &strSecret);
