...
void UnlimitedSetup(void)
{
    ...
    if (nMiningSvForkTime == 0)
    {
        ...
        ModifiableParams().ModifiableCheckpoints().mapCheckpoints[556767] =
            uint256S("0000000000000000004626ff6e3b936941d341c5932ece4357eeccac44e6d56c");
        // * UNIX timestamp of last checkpoint block
        ModifiableParams().ModifiableCheckpoints().nTimeLastCheckpoint = 1542304936;
        // * total number of transactions between genesis and last checkpoint
        ModifiableParams().ModifiableCheckpoints().nTransactionsLastCheckpoint = 265567564;
        // * estimated number of transactions per day after checkpoint (~3.5 TPS)
        ModifiableParams().ModifiableCheckpoints().fTransactionsPerDay = 280000.0;
    }
    else if (nMiningSvForkTime != 0)
    {
        ...
        // * UNIX timestamp of last checkpoint block
        ModifiableParams().ModifiableCheckpoints().nTimeLastCheckpoint = 1542305817;
        // * total number of transactions between genesis and last checkpoint
        ModifiableParams().ModifiableCheckpoints().nTransactionsLastCheckpoint = 265615408;
        // * estimated number of transactions per day after checkpoint (~3.5 TPS)
        ModifiableParams().ModifiableCheckpoints().fTransactionsPerDay = 280000.0;
    }
    else
    {
        ...
        // * UNIX timestamp of last checkpoint block
        ModifiableParams().ModifiableCheckpoints().nTimeLastCheckpoint = 1526410186;
        // * total number of transactions between genesis and last checkpoint
        ModifiableParams().ModifiableCheckpoints().nTransactionsLastCheckpoint = 249416375;
        // * estimated number of transactions per day after checkpoint (~3.5 TPS)
        ModifiableParams().ModifiableCheckpoints().fTransactionsPerDay = 280000.0;
    }
}
