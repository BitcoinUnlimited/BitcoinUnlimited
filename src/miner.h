...
private:
    ...
    void AddToBlock(std::vector<const CTxMemPoolEntry*> *txs, CTxMemPool::txiter iter);

    // Methods for how to add transactions to a block.
    /** Add transactions based on modified feerate */
    void addScoreTxs(std::vector<const CTxMemPoolEntry*> *txs);
    /** Add transactions based on tx "priority" */
    void addPriorityTxs(std::vector<const CTxMemPoolEntry*> *txs);
