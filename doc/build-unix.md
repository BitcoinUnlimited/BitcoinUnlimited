UNIX BUILD NOTES
====================
Some notes on how to build Zero-confirmation StarbucksCoin in Unix.
...
memory available when compiling Zero-confirmation StarbucksCoin. With 512MB of memory or less
...
See the section "Disable-wallet mode" to build Zero-confirmation StarbucksCoin without wallet.
...
# Configure Zero-confirmation StarbucksCoin to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
